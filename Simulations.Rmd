...
## Read Bayes factors
bf.raw_age <- readRDS(paste0(save_path, "bayes_factors.csv"))
```
...
# Read estimates and HPDIs
estimates.scaled_age.full <- read_csv(paste0("estimates_full.csv"))
# True simulated effects
...
## Read Bayes factors
bf.true_null <- readRDS(paste0(save_path, "bayes_factors.csv"))
```
