...
if(run_models){
  ...
  search.dichotomy <- function(sim.fun, sim.type, n_min, n_max, pwr_goal = .8){
    ...
    repeat{
      ...
      bfs <- future_map_dbl(1:n_sims, possibly(sim.fun, NA),
  ...
  n_infants_crit.noctrl <- search.dichotomy(sim.noctrl, "no-ctrl",
                                            n10_infants_min, n10_infants_max)
  n_infants_crit.noctrl.alt <- search.dichotomy(sim.noctrl, "no-ctrl_alt",
                                                n10_infants_min, n10_infants_max)
  beep(8)
}
```
...
pwr.design <- tibble(design = as_factor(c("_ctrl_", "_no-ctrl_", "_no-ctrl_alt_"))) %>%
...
ggplot(pwr.design,
  ...
  scale_color_brewer(palette = "Dark2",
                     breaks = c("_ctrl_", "_no-ctrl_", "_no-ctrl_alt_"),
                     labels = c("control", "no control", "no control (alt.)"))
```
